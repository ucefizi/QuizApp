...
public class MainController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getRequestURI().equals(applicationContextPath + "/")) {
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsps/home.jsp");
			dispatcher.forward(request, response);
		} else if (request.getRequestURI().equals(applicationContextPath + "/userPanel")) {
			RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsps/userPanel.jsp");
			dispatcher.forward(request, response);
		}
